...
import rajkishor from '../assets/Images/rajkishor.jpg'

const Class8 = () => {
  return (
    <div className='min-h-screen'>
      <h1 className='text-center font-bold text-2xl mt-5 underline text-white'>Class-8</h1>
      <h1 className='text-center font-bold text-xl mt-5 text-white'>Class-teacher</h1>
           <div className='sm:h-[390px] sm:w-[300px] bg-amber-200 rounded-tl-[6px] rounded-tr-[6px] text-black rounded-xl mx-auto text-center mt-8'>
             <img className='rounded-l h-[280px] w-full object-cover rounded-tl-[6px] rounded-tr-[6px] ' src={rajkishor} alt='' />
